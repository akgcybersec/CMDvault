...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        setError("");
        const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["verifyUser"])(username, password);
        if (!ok) {
            setError("Invalid credentials");
            return;
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setSession"])(true);
        router.push("/vault");
    };
...
//# sourceMappingURL=_43f5148b._.js.map