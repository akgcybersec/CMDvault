...
async function GET() {
    const rows = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("SELECT * FROM notes ORDER BY title ASC").all();
    const tagRows = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare(`SELECT nt.note_id, t.id as tag_id, t.name, t.created_at
       FROM note_tags nt
...
async function POST(request) {
    try {
        ...
        const existingNote = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("SELECT id FROM notes WHERE LOWER(title) = LOWER(?)").get(title.trim());
        if (existingNote) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `A note with the title "${title.trim()}" already exists`
            }, {
                status: 409
            });
        }
        const now = new Date().toISOString();
        const info = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare("INSERT INTO notes (title, content, created_at) VALUES (?, ?, ?)").run(title.trim(), content, now);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__73097250._.js.map